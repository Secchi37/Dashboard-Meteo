        ...
        <Row xs={1} md={2} lg={6}>
          <Col sm style={{ color: 'white' }}>
            ...
            <ul style={{ listStyleType: 'none', margin: 0, padding: 0 }}>
              ...
              <li style={viewP ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewP(true);
                }}
                onMouseLeave={() => {
              ...
              <li style={viewC ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewC(true);
                }}
                onMouseLeave={() => {
          ...
          <Col style={{ color: 'white' }}>
            <p><h4 >Services</h4></p>
            <ul style={{ listStyleType: 'none', margin: 0, padding: 0 }}>
              <li style={viewA ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewA(true);
                }}
                onMouseLeave={() => {
              ...
              <li style={viewR ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewR(true);
                }}
                onMouseLeave={() => {
              ...
              <li style={viewI ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewI(true);
                }}
                onMouseLeave={() => {
          ...
          <Col sm style={{ color: 'white' }}><p><h4>Supporto</h4></p>
            <ul style={{ listStyleType: 'none', margin: 0, padding: 0 }}>
              <li style={viewPV ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewPV(true);
                }}
                onMouseLeave={() => {
              ...
              <li style={viewL ? { color: 'white' } : { color: 'grey' }}
                onMouseEnter={() => {
                  setViewL(true);
                }}
                onMouseLeave={() => {
