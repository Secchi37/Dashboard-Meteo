            ...
            <Row fluid>
                <Col sm={4}>
                    ...
                    {punti.map((punti, index) => (
                        <ul>{punti === '' ? null : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bullseye" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" fill="orangered"/>
                            <path d="M8 13A5 5 0 1 1 8 3a5 5 0 0 1 0 10zm0 1A6 6 0 1 0 8 2a6 6 0 0 0 0 12z" fill="orangered"/>
                            <path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="orangered"/>
                    ...
                    <ListGroup horizontal style={{ boxShadow: ' 0px 5px 20px 10px rgba(0, 0, 0, 0.10)' }}>
                        <ListGroup.Item action onClick={() => changeText('mission')} onMouseEnter={() => { setColorM(true) }} onMouseLeave={() => { title === mission[0].title ? setColorM(true) : setColorM(false) }}
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill={!colorM ? 'currentColor' : 'orangered'} stroke={!colorM ? null : 'orangered'} class="bi bi-check2-circle" viewBox="0 0 16 16">
                                <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0z" fill="black"/>
                                <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z" fill="black"/>
