...
export default function BoxSkills() {
    ...
    return (
        <Container fluid
            style={{ paddingBottom: '15%', marginTop: '2%', marginLeft: '15%' }}>
                ...
                {dataS.map((dataS, index) => (
                    ...
                    >
                        ...
                        <Card.Img src={require('../img/shape/shape-3.png')} key={index}
                            style={num === index ? { position: 'relative', zIndex: 1, marginLeft: '-5%' } : {
                        ...
                        <Card.Img src={require('../img/icons/' + `${dataS.img}` + '.png')} key={index}
                            style={num === index ?
                                {
                                    marginTop: '25%',
                                    width: 63, heigth: 63,
